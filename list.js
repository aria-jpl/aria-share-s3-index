...
function getS3Data(marker, table) {
  ...
  // set loading notice
  $('#files').html('<div class="spinner-container"><img class="ajax-load-spinner" src="//assets.okfn.org/images/icons/ajaxload-circle.gif" /></div>');
  $.get(s3_rest_url)
    .done(function(data) {
...
function renderTableHeader() {
	...
	th_icon.html('<img src="/index-style/icons/blank.gif" alt="" height="16" width="16">');
